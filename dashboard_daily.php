          ...
          <div class="row">
            <div class="lge-toolbar-left">
              ...
              <div class="btn-group btn-group-lg calendar-view-buttons">
                <a href="dashboard_daily.php" class="btn btn-default hidden-xs active"><i class="icon-medium icon-daily"></i><small>DAILY</small></a>
                <a href="dashboard.php" class="btn btn-default"><i class="icon-medium icon-weekly"></i><small>WEEKLY</small></a>
            ...
            <div class="lge-toolbar-right">
              ...
              <h4 class="visible-xs">MELISSA BATES</h4>
              ...
              <div class="right-nav-box">
                <table class="dashboard-table-header">
                  <thead>
                    <tr>
                      <th>&nbsp;</th>
                      <th><h6>MELISSA BATES</h6></th>
                      <th><h6>EMILY BERGMAN</h6></th>
                      <th><h6>CLAIRE NOLLE</h6></th>
                      <th><h6>ANDREW HUDSON</h6></th>
                      <th><h6>SHABBIR HOSSAIN</h6></th>
                      <th><h6>RHONDA BAIN</h6></th>
                      <th><h6>KYLIE GROOM</h6></th>
                    </tr>
                  </thead>
                </table>
                  ...
                  <table class="dashboard-table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td><div class="w-relative"><div class="apt apt-orange apt-add"><a data-toggle="modal" data-target=".new-booking" class="action action-add" href="#"></a></div></div></td>
                        <td></td>
                        <td></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td><div class="w-relative"><div class="apt apt-red apt-add"><a data-toggle="modal" data-target=".new-booking" class="action action-add" href="#"></a></div></div></td>
                        <td></td>
                        <td><div class="w-relative"><div class="apt apt-green apt-add"><a data-toggle="modal" data-target=".new-booking" class="action action-add" href="#"></a></div></div></td>
                        <td></td>
                        <td><div class="w-relative"><div class="apt apt-orange apt-add"><a data-toggle="modal" data-target=".new-booking" class="action action-add" href="#"></a></div></div></td>
                        <td></td>
                        <td></td>
